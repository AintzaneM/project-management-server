...
router.post('/projects', (req, res, next) => {
  ...
  Project.create({
    ...
    .then(projectFromDB => res.json(projectFromDB)) //send the query to the client
...
const { projectId } = req.params;
    ...
    Project.findByIdAndUpdate(projectId, req.body) //passing 2 arguments the id, and the data
